...
export type PlanCommand = { id: number; type: 'move_joints' | 'move_j' | 'move_l'; startTargetId: number | null; endTargetId: number; speed: number; acceleration: number; deceleration: number; joints?: number[] };
